...
import { Route as authedSettingsSystemRouteImport } from './routes/(authed)/settings.system'
...
export interface FileRoutesById {
  ...
  '/(authed)/settings/system': typeof authedSettingsSystemRoute
