...
_PASS_PREFIXES = ("/setup", "/static", "/healthz", "/v1/internal", "/v1")
...
async def bootstrap_gate(request: Request, call_next):
    ...
    REST + internal endpoints (/v1/*) are exempt — they never trigger the
    bootstrap UI and their auth is independent.
    """
...
async def _warn_unsafe_email_backend() -> None:
